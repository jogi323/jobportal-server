    ...
    LoginComponent.prototype.login = function () {
        ...
        this.userService.attemptAuth(this.user).subscribe(function (res) {
            if (res.userType) {
                ...
                _this.close();
                _this.notificationsService.success('messahe', res.message, __WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].options);
            }
        }, function (err) {
            _this.close();
...
module.exports = "<section class=\"section-wrap promo-banners pb-30 slider-section\">\r\n    <div class=\"container\">\r\n        <div class=\"row\">\r\n            <div *ngIf=\"!selectedUserType || (userType == 'employer')\" (click)=\"selectedUser('employer')\" class=\"col-xs-4 col-xxs-12 mb-30 promo-banner color-base\">\r\n                <a><img src=\"assets/img/Photos/assistant1.jpg\" alt=\"\">\r\n                    <div class=\"promo-inner valign\">\r\n                        <h2>Employer</h2>\r\n                        <span>Join and find Job Seekers Now</span>\r\n                    </div>\r\n                </a>\r\n            </div>\r\n\r\n            <div *ngIf=\"!selectedUserType || (userType == 'jobseeker')\" (click)=\"selectedUser('jobseeker')\" class=\"col-xs-4 col-xxs-12 mb-30 promo-banner color-base\">\r\n                <a><img src=\"assets/img/Photos/doctor.jpg\" alt=\"\">\r\n                    <div class=\"promo-inner valign\">\r\n                        <h2>Job Seeker</h2>\r\n                        <span>Join To find Work</span>\r\n                    </div>\r\n                </a>\r\n            </div>\r\n\r\n            <div *ngIf=\"!selectedUserType\" class=\"col-xs-4 col-xxs-12 mb-30 product-description-wrap\">\r\n                <h1 class=\"product-title\">Register to Hire Job Seekers</h1>\r\n                <p class=\"short-description\">As many in the dental industry reach retirement, job opportunities are expected to increase. The employment outlook for this group projects an 18% average increase between 2014 and 2024. States with the highest concentrations of opportunities\r\n                    for dental occupations overall include Massachusetts and Maryland.\r\n                </p>\r\n            </div>\r\n            <div class=\"back-icon\" *ngIf=\"selectedUserType\">\r\n                <h2><i class=\"fa fa-arrow-left\" aria-hidden=\"true\" (click)='goBack()'></i></h2>\r\n            </div>\r\n            <div *ngIf=\"selectedUserType\" class=\"col-xs-8 col-xxs-12 mb-30 forms-container form-box-pad\">\r\n                <h3>Register</h3>\r\n                <div class=\"\">\r\n                    <!-- <p>If you dont have an account, register now.</p> -->\r\n                    <form name=\"employeeRegisterForm\" #employeeRegisterForm='ngForm' novalidate>\r\n                        <div class=\"form-group\">\r\n                            <label for=\"username\">Referred By</label>\r\n                            <select name=\"reference\" id=\"select\" class=\"form-control\" [(ngModel)]=\"employee.Referred_By\" #reference=\"ngModel\" required>\r\n                        <option value=\"\">Select One…</option>\r\n                        <option value=\"Mailing\">Mailer</option>\r\n                        <option value=\"Deental Meeting/Convection\">Dental Meeting/Convention</option>\r\n                        <option value=\"Internet Search\">Internet Search</option>\r\n                        <option value=\"Facebook\">Facebook</option>\r\n                        <option value=\"Friend\">Friend</option>\r\n                        <option value=\"Other\">Other</option>\r\n                    </select>\r\n                            <div *ngIf=\"reference.errors && (reference.dirty || reference.touched)\" class=\"error\">\r\n                                <div [hidden]=\"!reference.errors.required\">Please select reference from options</div>\r\n                            </div>\r\n                        </div>\r\n\r\n                        <div class=\"row form-group\">\r\n                            <div class=\"pull-left col-lg-6 form-group\">\r\n                                <label for=\"username\">First Name</label>\r\n                                <input name=\"FirstName\" type=\"text\" placeholder=\"FirstName\" class=\"form-control\" [(ngModel)]=\"employee.Firstname\" #FirstName=\"ngModel\" required>\r\n                                <div *ngIf=\"FirstName.errors && (FirstName.dirty || FirstName.touched)\" class=\"error\">\r\n                                    <div [hidden]=\"!FirstName.errors.required\">Please Enter First name</div>\r\n                                </div>\r\n                            </div>\r\n                            <div class=\"pull-right col-lg-6 form-group\">\r\n                                <label for=\"username\">Last Name</label>\r\n                                <input name=\"LastName\" type=\"text\" placeholder=\"LastName\" class=\"form-control\" [(ngModel)]=\"employee.Lastname\" #LastName=\"ngModel\" required>\r\n                                <div *ngIf=\"LastName.errors && (LastName.dirty || LastName.touched)\" class=\"error\">\r\n                                    <div [hidden]=\"!LastName.errors.required\">Please Enter Last name</div>\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n\r\n                        <div class=\"form-group\">\r\n                            <label for=\"email\">Email address:</label>\r\n                            <input name=\"email\" type=\"email\" placeholder=\"Email address\" class=\"form-control\" [(ngModel)]=\"employee.Email_Address\" #email=\"ngModel\" pattern=\"^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,3}$\" required>\r\n                            <div *ngIf=\"email.errors && (email.dirty || email.touched)\" class=\"error\">\r\n                                <div [hidden]=\"!email.errors.required\">Please Enter Email-Id</div>\r\n                                <div [hidden]=\"!email.errors.pattern\">Enter a valid email such as abc@xyz.com</div>\r\n                            </div>\r\n                        </div>\r\n\r\n                        <div class=\"form-group\">\r\n                            <label for=\"pwd\">Password:</label>\r\n                            <input name=\"password\" id=\"password\" type=\"password\" placeholder=\"Password \" class=\"form-control\" [(ngModel)]=\"employee.Password\" minlength=\"8\" #password=\"ngModel\" required>\r\n                            <div *ngIf=\"password.errors && (password.dirty || password.touched)\" class=\"error\">\r\n                                <div [hidden]=\"!password.errors.required\">Please Enter password</div>\r\n                                <div [hidden]=\"!password.errors.minlength\">Password length should be atleat 8</div>\r\n                            </div>\r\n                        </div>\r\n\r\n                        <div class=\"form-group\">\r\n\r\n                            <input type=\"checkbox\" [(ngModel)]=\"employee.checkbox\" name=\"checkbox\" #checkbox=\"ngModel\" required>\r\n                            <span class=\"remember\">I Agree to Privacy Policy / Terms and Conditions</span>\r\n                            <div *ngIf=\"checkbox.errors && (checkbox.dirty || checkbox.touched)\" class=\"error\">\r\n                                <div [hidden]=\"!checkbox.errors.required\">I Agree to Privacy Policy / Terms and Conditions\r\n                                </div>\r\n                            </div>\r\n                        </div>\r\n\r\n                        <div class=\"container-fluid\">\r\n                            <div class=\"row\">\r\n                                <button class=\"btn btn-md btn-dark pull-right\" [disabled]=\"!employeeRegisterForm.form.valid\" (click)='registerUser()'><span>Register</span></button>\r\n                            </div>\r\n                        </div>\r\n\r\n                    </form>\r\n\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</section>"
...
module.exports = "<!-- 404 -->\r\n<section class=\"section-wrap\">\r\n    <div class=\"container\">\r\n        <div class=\"row\">\r\n            <div class=\"container-fluid \">\r\n\r\n                <div class=\"col-sm-8 col-sm-offset-2 forms-container\">\r\n\r\n                    <h3>Contact Us</h3>\r\n                    <div class=\"form-box-pad\">\r\n                        <form name=\"contactusForm\" #contactusForm='ngForm' novalidate>\r\n                            <div class=\"row form-group\">\r\n                                <div class=\"col-lg-6\">\r\n                                    <label for=\"FirstName\">First Name:</label>\r\n                                    <input name=\"FirstName\" type=\"text\" placeholder=\"First Name\" class=\"form-control\" [(ngModel)]=\"data.FirstName\" #FirstName=\"ngModel\" required>\r\n                                    <div *ngIf=\"FirstName.errors && (FirstName.dirty || FirstName.touched)\" class=\"error\">\r\n                                        <div [hidden]=\"!FirstName.errors.required\">First name is required</div>\r\n                                    </div>\r\n                                </div>\r\n                                <div class=\"col-lg-6\">\r\n                                    <label for=\"pwd\">Last Name:</label>\r\n                                    <input name=\"LastName\" type=\"text\" placeholder=\"Last Name\" class=\"form-control\" [(ngModel)]=\"data.LastName\" #LastName=\"ngModel\" required>\r\n                                    <div *ngIf=\"LastName.errors && (LastName.dirty || LastName.touched)\" class=\"error\">\r\n                                        <div [hidden]=\"!LastName.errors.required\">Last name is required</div>\r\n                                    </div>\r\n                                </div>\r\n                            </div>\r\n                            <div class=\"row form-group\">\r\n                                <div class=\"col-lg-12\">\r\n                                    <label for=\"Email\">Email:</label>\r\n                                    <input name=\"email\" type=\"text\" placeholder=\"abc@xyz.com \" class=\"form-control\" [(ngModel)]=\"data.Email_Address\" #Email_Address=\"ngModel\" pattern=\"^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,3}$\" required>\r\n                                    <div *ngIf=\"Email_Address.errors && (Email_Address.dirty || Email_Address.touched)\" class=\"error\">\r\n                                        <div [hidden]=\"!Email_Address.errors.required\">Email Address is required</div>\r\n                                        <div [hidden]=\"!Email_Address.errors.pattern\">Enter valid Email Address like xyz@abc.com</div>\r\n                                    </div>\r\n                                </div>\r\n                            </div>\r\n                            <div class=\"row\">\r\n                                <div class=\"col-lg-12\">\r\n                                    <!--<p class=\"form-row notes ecommerce-validated\" id=\"order_comments_field\">-->\r\n                                    <label for=\"order_comments\">Enter Comments</label>\r\n                                    <textarea name=\"order_comments\" class=\"input-text\" id=\"order_comments\" placeholder=\"Leave us a message and we will get back to you.\" rows=\"2\" [(ngModel)]=\"data.Comments\" #Comments=\"ngModel\" required>\r\n                      \r\n                      </textarea>\r\n                                    <!--</p>-->\r\n                                    <div *ngIf=\"Comments.errors && (Comments.dirty || Comments.touched)\" class=\"error\">\r\n                                        <div [hidden]=\"!Comments.errors.required\">Comments are required</div>\r\n                                    </div>\r\n                                </div>\r\n                            </div>\r\n                            <div class=\"container-fluid\">\r\n                                <div class=\"row\">\r\n                                    <button class=\"btn btn-md btn-stroke pull-right\" [disabled]=\"!contactusForm.form.valid\" (click)=\"submit(contactusForm)\"><span>Submit</span></button>\r\n                                </div>\r\n                            </div>\r\n\r\n                        </form>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</section>\r\n<!-- end 404 -->"
...
var TopNavComponent = (function () {
    function TopNavComponent(router, route, dialogService, userService, loaderService, notificationsService) {
        var _this = this;
        this.router = router;
        this.route = route;
    ...
    TopNavComponent.prototype.showNotification = function (user) {
        if ((user.personalInfo || user.workInfo) && user) {
            this.notificationsService.info('', 'Your personal and/or work profiles are not updated', this.optionsBottom
            // environment.options
            );
        }
    };
    ...
    TopNavComponent.prototype.removeNotification = function () {
...
TopNavComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["ActivatedRoute"]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2_ng2_bootstrap_modal__["DialogService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_ng2_bootstrap_modal__["DialogService"]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4__shared_services_user_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__shared_services_user_service__["a" /* UserService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_5__services_loader_service__["a" /* LoaderService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__services_loader_service__["a" /* LoaderService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_6_angular2_notifications__["NotificationsService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6_angular2_notifications__["NotificationsService"]) === "function" && _f || Object])
], TopNavComponent);
